...
<header>
	...
	<table class=tb1 width=800 align=center border=1>
		<tr>
			...
			<td width=300><font size=3><b><p align=left>&nbsp;${list.name}</p></b></font></td>
		...
		<tr>
			<td width=100 height=28>기간</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.starttime}~${list.endtime}</p></td>
			
			<td width=100 height=28>시간</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.m_time}</p></td>
		</tr>

		<tr>
			<td width=100 height=28>장소</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.place}</p></td>
			<td width=100 height=28>주최</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.host}</p></td>
		</tr>

		<tr>
			<td width=100 height=28>연락처</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.call}</p></td>
			<td width=100 height=28>입장료</td>
			<td width=300><p align=left>&nbsp;&nbsp;${list.money}</p></td>
		</tr>

		<tr>
			<td width=100 height=28>홈페이지</td>
			<td width=300>
			<p align=left>&nbsp;&nbsp;
					...
					<c:choose>
						<c:when test="${fn:contains(homepage, 'http')}">
							...
							<img src="/img/home.gif" width="15" height="15" title="클릭하면 홈페이지로 이동합니다.">
							</a>
						</c:when>
			...
			<c:when test="${fn:contains(fList[0].p_poster_s, 'http')}">
				<c:forEach items="${fList}" var="fList">
					<img src="${fList.p_poster_s}"
						style="max-width:799px; vertical-align: middle;">
					<br>
					<br>
				</c:forEach>
			</c:when>

	...
	<br>
		<table width=800 align=center class=main>
			<tr>
				...
				<td width=100>분류</td>
				<td width=300>
				<select name=category value="${list.category}" class="input1">
			...
			<tr>
				<td colspan=4>
				<br>
				<textarea name=content rows=10 style="width: 99%;" class="input1">${content}</textarea></td>
			</tr>
...
<!-- 								<input type="submit" value="글쓰기" onclick="javascript:submitbutton();" class="btn1"> -->
							</center>
						</tr>
					</table>
